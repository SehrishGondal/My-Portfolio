      ...
      <TiltCard style={{ height: '100%' }}>
        <div
          ...
          style={{
            ...
            boxShadow: hovered ? `var(--shadow-card), 0 0 40px ${project.glow}` : 'var(--shadow-card)',
...
const PROJECTS = [
  {
    ...
    description: 'A compassionate mobile application designed to assist stroke patients with guided mobility exercises, progress tracking, and real-time caregiver support. Bridges the gap between medical care and daily rehabilitation.',
  ...
  },
  {
    ...
    description: 'A deep learning model leveraging Convolutional Neural Networks to intelligently classify images across multiple categories. Trained with optimized architecture for high accuracy and efficient inference.',
  ...
  },
  {
    ...
    description: 'A sleek, user-centric UI design for a complete shopping management platform. Features intuitive product browsing, cart management, and checkout flows — built with modern design principles for an exceptional user experience.',
      ...
      <div className="container">
        ...
        >
          ...
          <p style={{
            ...
            From healthcare apps to AI models — projects that solve real problems and push my boundaries.
          </p>
        </motion.div>
